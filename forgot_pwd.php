...
<title>Safari | Forgot password</title>
...
<p class="login-box-msg">Enter the email used during registration. A code will be sent to that email to enable you reset the password</p>
